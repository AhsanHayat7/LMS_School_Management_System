            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" action="{{ route('classes.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select type ="text" name = "student_id" id = "students" class="form-select mb-3"
                        ...
                        <div class="form-group">
                            <label for="teacher">Select Teahers</label>
                            <select type ="text" name = "teacher_id" id = "teachers" class="form-select mb-3"
